...
<body style="background-color: #e8eced;">
    ...
    <?php foreach($call->buku_data($id) as $key => $value) :?>
                ...
                <input type="hidden" name="id" value="<?php echo $value['id_buku']?>">
                    <h1 style="color: blue;">Pinjam Buku</h1><br>
                    <span style="font-size:18px; margin-left:40px;">Cover buku</span>
                    <img src="<?php echo $value['gambar_buku']?>" style="width: 150px; height:100px;"><br><br>
                    <label style=" position: relative; left: 100px;">Judul Buku</label><br><br>
                    <input type="text" name="judul" placeholder="Judul buku" required value="<?php echo $value['judul']?>"><br><br>
    <?php endforeach?>
                    <label style=" position: relative; left: 100px;">Tanggal Peminjaman</label><br><br>
                    <input type="date" name="awal"><br><br>
                    <label style=" position: relative; left: 100px;">Tanggal Pengembalian</label><br><br>
                    <input type="date" name="akhir"><br><br>
                    <label style=" position: relative; left: 100px;">Jumlah Buku yang dipinjam</label><br><br>
                    <input type="text" name="jumlah_buku" placeholder="masukkan stock buku" required><br><br>
